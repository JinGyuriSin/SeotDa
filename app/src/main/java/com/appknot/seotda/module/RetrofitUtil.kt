package com.appknot.seotda.module
...
import com.appknot.seotda.App.Companion.isTestServer
...
class RetrofitUtil {
    ...
    fun download(filePath: String, isStreaming: Boolean = false, pb: ProgressBar? = null) {
        fileCall?.enqueue(object : Callback<ResponseBody> {
            ...
            override fun onFailure(call: Call<ResponseBody>, t: Throwable) {
                hideProgress()
                failureListener?.invoke()
                app.logMessage("Retrofit download() onFailure: ${t.message}")
            }
        })
    }
    ...
    companion object {
        ...
        fun getUrl(): String {
            ...
            host = if (isTestServer) API_HOST_TEST else API_HOST
